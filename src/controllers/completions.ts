import type { promptBodySchema } from "../schemas/index.ts";
import { createOpenAICompletion } from "../utils/index.ts";
  ...
  const client = new OpenAI({
    apiKey:
      process.env.NODE_ENV === "development"
        ...
        : process.env.OPENAI_API_KEY,
    baseURL:
      process.env.NODE_ENV === "development" ? process.env.LMS_URL : undefined,
  });
